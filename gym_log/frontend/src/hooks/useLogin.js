...
export const useLogin = () => {
    ...
    const login = async (email, password) => {
        ...
        // Here data is 'fetched' from 'http://localhost:9000/api/user/login' using 'await' which pauses the execution of the function until it's completed, then assigns the result as the value of the variable 'response'.
