...
// This imports 'useLogin' Hook from the file 'useSignup' within the 'hooks' folder.
...
const Login = () => {
    ...
    const [password, setPassword] = useState('')
      // This initializes the variables 'error' and 'isLoading' along with the function 'login' from 'useLogin'.
